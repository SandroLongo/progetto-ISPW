...
public interface UtenteDao {
    ...
    public void addPaziente(String codice_fiscale, String nome, String cognome, Date nascita, String email, String telefono,
                            String pass) throws DaoException;
    public void addDottore(String codice_fiscale, String nome, String cognome, Date nascita, String email, String telefono,
